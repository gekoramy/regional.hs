...
public class General extends Person {
    ...
    public General(Long id, String email, String password, String name, String surname, LocalDate birthday, Long birthplace, String fc, Boolean gender, Long residence, Long workplace) {
