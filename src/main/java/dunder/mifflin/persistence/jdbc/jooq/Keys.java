...
public class Keys {
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<Record, Record> AVATAR__AVATAR_ID_FKEY = Internal.createForeignKey(dunder.mifflin.persistence.jdbc.jooq.Keys.PERSON_PKEY, Avatar.AVATAR, "avatar__avatar_id_fkey", Avatar.AVATAR.ID);
        public static final ForeignKey<Record, Record> CITY__CITY_PROVINCE_FKEY = Internal.createForeignKey(dunder.mifflin.persistence.jdbc.jooq.Keys.PROVINCE_PKEY, City.CITY, "city__city_province_fkey", City.CITY.PROVINCE);
        public static final ForeignKey<Record, Record> FOLLOWS__FOLLOWS_PATIENT_FKEY = Internal.createForeignKey(dunder.mifflin.persistence.jdbc.jooq.Keys.PERSON_PKEY, Follows.FOLLOWS, "follows__follows_patient_fkey", Follows.FOLLOWS.PATIENT);
        public static final ForeignKey<Record, Record> FOLLOWS__FOLLOWS_GENERAL_FKEY = Internal.createForeignKey(dunder.mifflin.persistence.jdbc.jooq.Keys.GENERAL_PKEY, Follows.FOLLOWS, "follows__follows_general_fkey", Follows.FOLLOWS.GENERAL);
        public static final ForeignKey<Record, Record> GENERAL__GENERAL_ID_FKEY = Internal.createForeignKey(dunder.mifflin.persistence.jdbc.jooq.Keys.PERSON_PKEY, General.GENERAL, "general__general_id_fkey", General.GENERAL.ID);
        public static final ForeignKey<Record, Record> GENERAL__GENERAL_WORKPLACE_FKEY = Internal.createForeignKey(dunder.mifflin.persistence.jdbc.jooq.Keys.PROVINCE_PKEY, General.GENERAL, "general__general_workplace_fkey", General.GENERAL.WORKPLACE);
        public static final ForeignKey<Record, Record> HS_ADMIN__HS_ADMIN_ID_FKEY = Internal.createForeignKey(dunder.mifflin.persistence.jdbc.jooq.Keys.PERSON_PKEY, HsAdmin.HS_ADMIN, "hs_admin__hs_admin_id_fkey", HsAdmin.HS_ADMIN.ID);
        public static final ForeignKey<Record, Record> HS_ADMIN__HS_ADMIN_WORKPLACE_FKEY = Internal.createForeignKey(dunder.mifflin.persistence.jdbc.jooq.Keys.PROVINCE_PKEY, HsAdmin.HS_ADMIN, "hs_admin__hs_admin_workplace_fkey", HsAdmin.HS_ADMIN.WORKPLACE);
