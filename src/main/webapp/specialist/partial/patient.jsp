                    ...
                    <div class="nav-mobile">
                        <nav>
                            ...
                            <div class="link-list-wrapper collapse" id="menu2">
                                <ul class="link-list">
                                    <li>
                                        <a class="list-item <c:if test="${fn:contains(pageContext.request.requestURI, '/specialist/exams')}">active</c:if>"
                                           href="${pageContext.request.contextPath}/specialist/exams?patient=${patient.id()}">Esami</a>
                                    </li>
                                    <li>
                                        <a class="list-item <c:if test="${fn:contains(pageContext.request.requestURI, '/specialist/medicines')}">active</c:if>"
